    ...
    return(
        <div className={classes.maintop}>
            ...
            <ul className={classes.maintop__links}>
                <li>Use any search option to find the first person</li>
                <li>You will get a list of users to choose from</li>
                <li>Repeat the process to find the second person</li>    
            </ul>          
        </div>
    )
}
